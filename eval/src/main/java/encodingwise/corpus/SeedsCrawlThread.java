...
public class SeedsCrawlThread extends Thread {
	...
	String SpecialCharset = null;
	private boolean isStop = false;

	public SeedsCrawlThread(String threadName, BlockingQueue<String> seedQueue,
			ConcurrentMap<String, Integer> charsetStat, ConcurrentMap<String, Integer> fetchedURLs, String SpecialCharset) {
		super(threadName);
		...
		while (!isStop) {
			...
			try {
				...
				if (Charsets.isValid(charset)) {
					...
					if (charset.equalsIgnoreCase(SpecialCharset)) {
